...
1. ejs 설치
   ...
   * npm install ejs
     ...
     **app.js** 
     ...
     ```js
     app.set('view engine', 'ejs'); //app.set은 app.use보다 위에 쓰는 것이 좋음
     
     ```

   * routes 폴더에 index.js 파일을 생성
   ...
   * views폴더를 생성하고 public폴더의 index.html을 **이동**

   * 이동한 index.html의 **확장자**를 **ejs**로 변경
...
2. 정리
   ...
   * 이하 routes 폴더내 파일
     ...
     **members.js**
     ...
     ```js
     const members = [
       { name: "a", email: "b", comments: "c" },
       { name: "d", email: "e", comments: "f" }
     ];
